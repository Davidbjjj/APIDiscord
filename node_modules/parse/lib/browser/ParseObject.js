...
var ParseObject = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ParseObject, [{
    ...
    key: "addAll",
    value: function (attr /*: string*/, items /*: Array<any>*/) /*: ParseObject | boolean*/{
    ...
    key: "fetch",
    value: function (options /*: FetchOptions*/) /*: Promise<any>*/{
      options = options || {};
    ...
    value: function (keys /*: String | Array<string | Array<string>>*/, options /*: RequestOptions*/) /*: Promise<any>*/{
      options = options || {};
    ...
    key: "save",
    value: function (arg1 /*: undefined | string | { [attr: string]: any } | null*/, arg2 /*: SaveOptions | any*/, arg3 /*:: ?: SaveOptions*/) /*: Promise<this>*/{
      var _this = this;
      var attrs;
      var options;
    ...
    key: "destroy",
    value: function (options /*: RequestOptions*/) /*: Promise<void | ParseObject>*/{
      options = options || {};
    ...
    value: function (list /*: Array<ParseObject>*/, options /*: FetchOptions*/) {
      options = options || {};
...
var DefaultController = {
  fetch: function (target /*: ParseObject | Array<ParseObject>*/, forceFetch /*: boolean*/, options /*: RequestOptions*/) /*: Promise<Array<ParseObject | undefined> | ParseObject | undefined>*/{
    var localDatastore = _CoreManager.default.getLocalDatastore();
  ...
  destroy: function (target /*: ParseObject | Array<ParseObject>*/, options /*: RequestOptions*/) /*: Promise<ParseObject | Array<ParseObject>>*/{
  ...
  save: function (target /*: ParseObject | Array<ParseObject | ParseFile>*/, options /*: RequestOptions*/) /*: Promise<ParseObject | Array<ParseObject> | ParseFile>*/{
